                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            <div class="mb-2">
                                ...
                                <a class="btn btn-success mt-3 " target="_blank" href="export_excel.php?tanggal_awal=<?= $_POST['tanggal_awal']." 00:00:00";?>&tanggal_akhir=<?= $_POST['tanggal_akhir']." 23:59:59"; ?>">Export</a>
                            </div>
                        </form>
                    </div>
  </div>
